...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="../src/aset_proses_tambah.php">
            ...
            <input type="number" step="1" name="jumlah_unit" min="1">

            <label>Kondisi Baik:</label>
            <input type="number" step="1" name="kondisi_baik" min="0">

            <label>Kondisi Rusak:</label>
            <input type="number" step="1" name="kondisi_rusak" min="0">
        ...
        <h2>Import Aset dari Excel/CSV</h2>
        <form method="post" action="../src/aset_import_excel.php" enctype="multipart/form-data"> 
            ...
            <p style="font-size:0.95em;color:#888;margin-top:8px;">
                Format kolom: nama, jenis, produsen, harga, tanggal_beli, garansi, lokasi
            </p>
        </form>
